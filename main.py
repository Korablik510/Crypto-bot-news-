    ...
    try:
        response = requests.post(
            ...
            json={
                ...
                "messages": [{
                    "role": "user",
                    "content": "Ти досвідчений крипто-трейдер який веде популярний Telegram канал. Переклади та перекажи цю новину українською мовою. Вимоги: 2-3 речення коротко і по справі. Пиши грамотно без помилок. Крипто-терміни також пиши правильно і без помилок. Додай 3-5 емодзі до змісту. Без посилань і хештегів. Новина: " + title
                }],
                "max_tokens": 200
            },
            timeout=15
