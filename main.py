    ...
    try:
        response = requests.post(
            ...
            json={
                ...
                "messages": [{
                    "role": "user",
                    "content": "Ты опытный крипто-трейдер который ведет популярный Telegram канал. Переведи и перескажи эту новость на русском языке. Требования: 2-3 предложения коротко и по делу. Пиши грамотно без ошибок. Добавь 3-5 эмодзи по смыслу. Используй живой язык трейдера не сухой новостной стиль. Без ссылок и хештегов. Новость: " + title
                }],
                "max_tokens": 200
            },
            timeout=15
